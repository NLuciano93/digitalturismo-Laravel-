...
/*----------------CARRITO--------------------*/
Route::get('/adminCarrito', 'CarritoController@index');
Route::get('/carritoAlta', 'CarritoController@create');
Route::post('/carritoAlta', "UsuariosController@carritoAlta");
Route::get('/carritoCompras', 'UsuariosController@carrito');